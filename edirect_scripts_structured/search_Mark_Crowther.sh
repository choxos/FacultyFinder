...
if [ -s data/publications/pubmed/CA/ON/CA-ON-002_mcmaster.ca/Mark_Crowther_publications.txt ]; then
    echo "✅ Search completed: data/publications/pubmed/CA/ON/CA-ON-002_mcmaster.ca/Mark_Crowther_publications.txt"
    echo "📊 Publications found: $(grep -c "^PMID-" data/publications/pubmed/CA/ON/CA-ON-002_mcmaster.ca/Mark_Crowther_publications.txt)"
else
    echo "❌ No results or search failed: data/publications/pubmed/CA/ON/CA-ON-002_mcmaster.ca/Mark_Crowther_publications.txt"
fi
